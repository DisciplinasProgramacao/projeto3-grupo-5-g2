...
public class Servicos {
    ...
    private int tempoMinimoPermanenciaHoras;
     ...
     */
    public Servicos(String nome, double valor, int tempoMinimoPermanenciaHoras) {
        this.nome = nome;
        this.valor = valor;
     ...
     */
    public double calcularCustoServico(int horasEstacionado) {
